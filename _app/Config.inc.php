...
define('MAILUSER', 'wsphp@upinside.com.br');
define('MAILPASS', '123456a');
define('MAILPORT', '587');
define('MAILHOST', 'smtp.upinside.com.br');

// DEFINE IDENTIDADE DO SITE ####################
define('SITENAME', 'Cidade Online');
define('SITEDESC', 'Este site foi desenvolvido no curso de PHP Orientado a Objetos da UPINSIDE TREINAMENTOS');
