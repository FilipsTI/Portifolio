<div class="content cat_list">
    ...
    <section>
        ...
        if ($delCat):
            ...
            WSErro($deletar->getResult()[0], $deletar->getResult()[1]);
        endif;
        ...
        if (!$readSes->getResult()):
            ...
            foreach ($readSes->getResult() as $ses):
                ...
                $countSesCats = $readPosts->getRowCount();
                ?>
                <section>
                    ...
                    if (!$readSub->getResult()):
                        ...
                        foreach ($readSub->getResult() as $sub):
                            ...
                            <article<?php if ($a % 3 == 0) echo ' class="right"'; ?>>
                                <h1><a target="_blank" href="../categoria/<?= $sub['category_name']; ?>" title="Ver Categoria"><?= $sub['category_name']; ?></a> ( <?= $readCatPosts->getRowCount(); ?> ) </h1>
