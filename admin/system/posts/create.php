        ...
        if (isset($post) && $post['SendPostForm']):
            ...
            if ($cadastra->getResult()):
                ...
                if (!empty($_FILES['gallery_covers']['tmp_name'])):
                    $sedGallery = new AdminPost;
                    $sedGallery->gbSend($_FILES['gallery_covers'], $cadastra->getResult());
                endif;
            ...
            <div class="label_line">
                ...
                <label class="label_small">
                    ...
                    <select name="post_author">
                        <option value="<?= $_SESSION['userlogin']['user_id'] ?>"> <?= "{$_SESSION['userlogin']['user_name']} {$_SESSION['userlogin']['user_lastname']}"; ?> </option><?php
                        $readAut = new Read;
