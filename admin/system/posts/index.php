        ...
        if ($action):
            ...
            switch ($action):
                ...
                case 'inative':
                    ...
                    WSErro("O status do post foi atualizado para <b>inativo</b>. Post agora é um racunho", WS_ALERT);
                    break;
                ...
                default:
                    WSErro("Ação não foi identificada pelo sistema, favor use os botões", WS_ALERT);
            endswitch;
        endif;
        ...
        if ($readPosts->getResult()):
            foreach ($readPosts->getResult() as $post):
                ...
                <article<?php if ($posti % 2 == 0) echo ' class="right"'; ?> <?= $status; ?>>
                    ...
                    <h1><a target="_blank" href="../artigo/<?= $post_name; ?>" title="Ver Post"><?= Check::Words($post_title, 30) ?></a></h1>
                    <ul class="info post_actions">
                        ...
                        <?php else: ?>
                            <li><a class="act_ative" href="painel.php?exe=posts/index&post=<?= $post_id; ?>&action=inative">Inativar</a></li>
                        <?php endif; ?>

                        <li><a class="act_delete" href="painel.php?exe=posts/index&post=<?= $post_id; ?>&action=delete">Deletar</a></li>
                    </ul>
