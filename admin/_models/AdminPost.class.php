 ...
 * Responsável por gerencia os posts do Admin do sistema
 * 
...
class AdminPost {
    ...
    public function ExeCreate(array $Data) {
        ...
        if (in_array('', $this->Data)):
            ...
            if (isset($upload) && $upload->getResult()):
                ...
                $_SESSION['errCapa'] = "<b>ERRO AO ENVIAR CAPA:</b> Tipo de arquivo inválido, envie imagens JPEG ou PNG";
                $this->Create();
            endif;
    ...
    public function gbSend(array $Images, $PostId) {
        ...
        if (!$ImageName->getResult()):
            ...
            if ($u > 1):
                $this->Error = ["Galeria Atualizada: Foram enviadas {$u} imagens para galeria desse post", WS_ACCEPT];
                $this->Result = true;
            endif;
        endif;
    }
    ...
    private function Update() {
        ...
        $Update->ExeUpdate(self::Entity, $this->Data, "WHERE post_id = :id", "id={$this->Post}");
        if ($Update->getResult()):
            $this->Error = ["O post {$this->Data['post_title']} foi atualizado com sucesso no sistema", WS_ACCEPT];
            $this->Result = true;
        endif;
    }
