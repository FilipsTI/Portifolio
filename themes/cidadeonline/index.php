...
<section class="main-slider">
    ...
    <div class="container">
        ...
        <div class="slidecount">
            ...
            if (!$post->getResult()):
                WSErro("Desculpa, ainda não existem noticias cadastradas. Favor volte mais tarde", WS_INFOR);
            else:
...
<div class="site-container">
    ...
    <section class="main-destaques">
        ...
        <section class="main_lastnews">
            ...
            if (!$post->getResult()):
                WSErro("Desculpe, não existe uma noticia destaque para ser exibida agora. Favor, volte depois", WS_INFOR);
            else:
